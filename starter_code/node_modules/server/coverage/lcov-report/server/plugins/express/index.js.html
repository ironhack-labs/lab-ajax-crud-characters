...
71
72
73</td><td class="line-coverage quiet"><span class="cline-any cline-yes">27x</span>
...
&nbsp;
  ...
  close: ctx =&gt; new Promise((resolve, reject) =&gt; {
    ctx.server.close(err =&gt; err ? <span class="branch-0 cbranch-no" title="branch not covered" >reject() </span>: resolve());
  })
};
&nbsp;</pre></td></tr>
</table></pre>
