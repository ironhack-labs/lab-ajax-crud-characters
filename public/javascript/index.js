...
window.addEventListener('load', () => {
  ...
  .addEventListener('click', function (event) {
    let id = document.getElementsByName('charcater-id')
  ...
  let cartoon =  document.querySelector('#new-character-form input[name="cartoon"]').check
  console.log(occupation,name,weapon,cartoon)
  let character = {
    occupation,
    name,
    weapon,
